...
## Otorgamiento de CEL y Construcción del Folio
...
## OBJETIVO DEL AGENTE
Completa el **Punto 03: Otorgamiento de CEL y Construcción del Folio** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| CENACE (medición y liquidación) | DACG S-CEL (RES/174/2016 y A/067/2017) | Disposición 32.B | “Los datos de medición… reportados por el Cenace al S-CEL serán la base para el otorgamiento…” |
| Transportistas y Distribuidores | DACG S-CEL | Disposición 26 | “En los diez primeros días hábiles… informarán… la energía eléctrica generada…” |
| Centrales Eléctricas Limpias | NOM-017-CRE-2019 | Numeral 20 | “La Central Eléctrica Limpia debe entregar… una base de datos… a través del Sistema CEL”. |
...
- Explicar cómo se construye hoy el folio y dónde se rompe la trazabilidad.
- Incluir ejemplo breve: folio actual (componentes) vs folio objetivo (componentes).
- Proponer identificador técnico permanente no dependiente de datos administrativos cambiantes.
