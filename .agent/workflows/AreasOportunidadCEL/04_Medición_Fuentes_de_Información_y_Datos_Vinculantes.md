...
## Medición, Fuentes de Información y Datos Vinculantes
...
## OBJETIVO DEL AGENTE
Completa el **Punto 04: Medición, Fuentes de Información y Datos Vinculantes** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| CENACE (liquidaciones y reliquidaciones) | DACG S-CEL | Disposición 32.B | “Los datos de medición… utilizados en las liquidaciones y reliquidaciones…” |
| Distribuidores (GLD) | DACG S-CEL | Disposición 29.A | “Los Suministradores que representen GLD… información que proporcione el Distribuidor… al S-CEL”. |
| Generadores (abasto aislado) | DACG S-CEL | Disposición 30.B | “Para el abasto aislado… reportar al S-CEL la energía generada neta y consumida mensualmente”. |
...
- Identificar fuentes primarias de datos (CENACE, T/D, GLD, abasto aislado, etc.).
- Precisar qué datos son vinculantes y en qué momento del ciclo (liquidación/reliquidación).
- Proponer controles de consistencia y “cierre técnico” de información para evitar cambios ex post.
