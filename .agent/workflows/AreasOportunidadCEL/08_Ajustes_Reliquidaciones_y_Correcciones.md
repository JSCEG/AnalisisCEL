...
## Ajustes, Reliquidaciones y Correcciones
...
## OBJETIVO DEL AGENTE
Completa el **Punto 08: Ajustes, Reliquidaciones y Correcciones** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| Reliquidaciones | Manuales CENACE / DACG S-CEL | Numeral/disposición aplicable | Cita textual exacta desde `contexto`. |
| CENACE (ajustes) | DACG S-CEL | Disposición aplicable | Cita textual exacta desde `contexto`. |
...
- Explicar efectos de ajustes y reliquidaciones sobre CEL emitidos/usados.
- Identificar ventanas temporales y riesgos de correcciones tardías.
- Proponer límites, cierres y reglas de corrección con evidencia verificable.
