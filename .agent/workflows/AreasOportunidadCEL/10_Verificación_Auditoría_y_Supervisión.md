...
## Verificación, Auditoría y Supervisión
...
## OBJETIVO DEL AGENTE
Completa el **Punto 10: Verificación, Auditoría y Supervisión** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| CENACE (evidencia técnica) | DACG S-CEL | Disposición 27 | “El Cenace reportará… cualquier caso… violación de instrucciones de despacho”. |
| Unidades Acreditadas | RES/2910/2017 | Numerales 1.1 y 63 | Cita textual exacta desde `contexto`. |
...
- Identificar qué se audita, con qué evidencia y con qué periodicidad.
- Señalar vacíos de supervisión continua y trazabilidad de decisiones.
- Proponer bitácoras, controles y vistas agregadas para auditoría.
