...
## OBJETIVO DEL AGENTE
Completa el **Punto 11: Régimen de Sanciones** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| Régimen sancionatorio | LSE 2025 / instrumento aplicable | Artículo aplicable | Cita textual exacta desde `contexto`. |
| Verificación | DACG S-CEL | Disposiciones aplicables | Cita textual exacta desde `contexto`. |
...
- Delimitar incumplimientos (material/formal/informativo) y su tratamiento.
- Separar incumplimiento por dolo vs por desfase sistémico.
- Proponer gradualidad, plazos de subsanación y medidas preventivas.
