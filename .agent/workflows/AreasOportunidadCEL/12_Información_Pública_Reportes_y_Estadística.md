...
## Información Pública, Reportes y Estadística
...
## OBJETIVO DEL AGENTE
Completa el **Punto 12: Información Pública, Reportes y Estadística** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| Información pública / reportes | DACG S-CEL | Disposiciones 60–61 (si aplican) | Cita textual exacta desde `contexto`. |
| Transparencia de precios | Instrumento aplicable | Artículo/numeral | Cita textual exacta desde `contexto`. |
...
- Definir qué información debe publicarse (agregada) para transparencia.
- Proponer reportes, periodicidad, definiciones y controles de calidad.
- Enfocar en utilidad para planeación y mercado, sin revelar datos sensibles.
