# 🧠 PLANTILLA MAESTRA DEL AGENTE – PUNTO 13
## Unidades Acreditadas y Dictamen Técnico
...
## OBJETIVO DEL AGENTE
Completa el **Punto 13: Unidades Acreditadas y Dictamen Técnico** en el archivo `AreasdeOportunidadCEL.tex` (actualmente contiene solo índice y está vacío).
...
|---|---|---|---|
| Unidades Acreditadas (dictamen técnico) | RES/2910/2017 | Numerales 1.1 y 63 | “Será responsabilidad… adjuntar el Dictamen Técnico…” |
| Medición ELC | NOM-017-CRE-2019 | Numeral 20 | “La Central Eléctrica Limpia debe entregar… base de datos…”. |

Clasifica cada fuente como: **primaria**, **declarativa**, **validación**, **auditoría/supervisión** o **planeación**.

## ENFOQUE ESPECÍFICO DEL PUNTO 13 (OBLIGATORIO)
- Definir rol de Unidades Acreditadas y Dictamen Técnico en elegibilidad y seguimiento.
- Identificar problemas: costos, tiempos, trazabilidad del dictamen, consistencia con NOM.
- Proponer requisitos mínimos, evidencias, y reglas de actualización/validación.
