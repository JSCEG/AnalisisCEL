...
## Mercado de Certificados de Energía Limpia y Bolsa No Onerosa
...
- Las **transacciones bilaterales** entre participantes.
- La **Bolsa No Onerosa de CEL** como mecanismo específico previsto en la normativa.
- Las **asimetrías de información** y su impacto en el funcionamiento del sistema.
...
11. Mercado de Certificados de Energía Limpia y transacciones bilaterales
12. Bolsa No Onerosa de Certificados de Energía Limpia

No abordar temas de precio del CEL, subastas, sanciones o factor de emisiones en este bloque.
...
1. Revisar **todas las fuentes disponibles en la carpeta de contexto**, incluyendo:
   ...
   - Manuales del CENACE
   - Lineamientos y acuerdos relacionados con CEL
   - Resoluciones específicas sobre la Bolsa No Onerosa
2. No asumir:
...
- Comisión Reguladora de Energía. (2016). *DACG del Sistema de CEL*. Disposición 49.
...
Antes del diagnóstico de **cada punto (11 y 12)**, identificar explícitamente las **fuentes de información** que inciden en el mercado y en la Bolsa No Onerosa.
...
- Sistema S-CEL (movimientos, transferencias)
- Bolsa No Onerosa (asignaciones sin contraprestación)
- SENER (definición de requisitos y metas)
- CENACE (oferta real de generación limpia)

---

## CONSIDERACIONES ESPECÍFICAS POR PUNTO

### Punto 11 · Mercado de Certificados de Energía Limpia y transacciones bilaterales

Analizar obligatoriamente:

- Marco jurídico que permite la transmisión de CEL.
- Funcionamiento de las transacciones bilaterales.
- Ausencia de un mercado organizado con información pública.
- Asimetrías de información entre participantes.
- Impacto de la falta de reportes agregados del mercado.

---

### Punto 12 · Bolsa No Onerosa de Certificados de Energía Limpia

Analizar obligatoriamente:

- Fundamento jurídico del mecanismo.
- Finalidad original de la Bolsa No Onerosa.
- Procedimiento de asignación de CEL sin contraprestación.
- Impactos sobre la equidad del sistema.
- Efectos indirectos en la señal del mercado de CEL.
- Riesgos regulatorios derivados de su uso recurrente.

---

## ESTRUCTURA DE ENTREGA (ESTRICTA)

Para **cada uno de los puntos 11 y 12**, desarrollar:
...
Redacta directamente el contenido correspondiente al **Bloque IV** dentro del archivo:
