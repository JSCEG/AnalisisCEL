...
## Instrumentos de Mediano y Largo Plazo del Sistema de Certificados de Energía Limpia (CEL)
...
Analizar, validar jurídicamente y documentar las **áreas de oportunidad** relacionadas con los **instrumentos de planeación de mediano y largo plazo** vinculados al Sistema de Certificados de Energía Limpia, en particular:

- El uso del CEL en **contratos de cobertura**.
- El papel de las **subastas de CEL** como instrumento de planeación **actualmente suspendido**.
- Los efectos de la ausencia de estos instrumentos en la disponibilidad futura de CEL y en el cumplimiento de obligaciones.
...
14. Certificados de Energía Limpia en contratos de cobertura
15. Subastas de Certificados de Energía Limpia como instrumento de planeación (actualmente suspendidas)

No abordar temas de precio del CEL, mercado bilateral, Bolsa No Onerosa ni sanciones en este bloque.

---

## REGLAS DE REDACCIÓN (ESTRICTAS)

- Lenguaje institucional mexicano, claro y directo.
...
- No proponer la reactivación automática de mecanismos suspendidos.
- No sugerir instrumentos financieros ajenos al marco jurídico vigente.
...
1. Revisar **todas las fuentes disponibles en la carpeta de contexto**, incluyendo:

   - Ley del Sector Eléctrico
   - Reglamento correspondiente
   - Disposiciones Administrativas de Carácter General del S-CEL
   - Bases del Mercado Eléctrico
   - Manuales de Subastas de Mediano y Largo Plazo (históricos)
   - Lineamientos y acuerdos aplicables a contratos de cobertura
   - Disposiciones transitorias vigentes
2. No asumir:

   - Temas operativos → validar en **Manuales / S-CEL**
...
- Secretaría de Energía. (2015). *Manual de Subastas de Largo Plazo*. Numeral 3.2.
...
Antes del diagnóstico de **cada punto (14 y 15)**, identificar explícitamente las **fuentes de información** que inciden en la planeación de mediano y largo plazo.
...
- SENER (metas y requisitos de CEL)
- Participantes Obligados
- Generadores Limpios
- Sistema S-CEL (registro de contratos y compromisos)
- Manuales de Subastas (históricos)
- Bases del Mercado Eléctrico
- CENACE (proyección de generación y despacho)

---

## CONSIDERACIONES ESPECÍFICAS POR PUNTO

### Punto 14 · Certificados de Energía Limpia en contratos de cobertura

Analizar obligatoriamente:

- Marco jurídico que permite o limita el uso del CEL en contratos de cobertura.
- Tratamiento del CEL como elemento contractual.
- Vacíos normativos para su seguimiento y cumplimiento.
- Riesgos jurídicos y operativos para los participantes.
- Impacto de estos contratos en la planeación de obligaciones futuras.

---

### Punto 15 · Subastas de Certificados de Energía Limpia como instrumento de planeación (actualmente suspendidas)

Analizar obligatoriamente:

- Rol original de las subastas de CEL.
- Integración CEL–energía–potencia.
- Señales de mediano y largo plazo que aportaban.
- Efectos de la suspensión en:
  - disponibilidad futura de CEL,
  - planeación del sistema,
  - cumplimiento de obligaciones.
- Ausencia de un instrumento sustituto con funciones equivalentes.

---

## ESTRUCTURA DE ENTREGA (ESTRICTA)

Para **cada uno de los puntos 14 y 15**, desarrollar:
...
- Propuesta de ajuste normativo:
  ...
  - Instrumento B (DACG, Lineamiento o Manual)

---

## GLOSARIO Y BIBLIOGRAFÍA

- Agregar términos relevantes si no existen (contrato de cobertura, planeación energética, subasta).
...
Redacta directamente el contenido correspondiente al **Bloque VI** dentro del archivo:
