# 🧠 PLANTILLA MAESTRA DEL AGENTE – PUNTO 02
## Declaracel: Declaraciones Provisionales, Riesgos y Controles
...
## OBJETIVO DEL AGENTE
Realiza la **validación jurídica integral** y la **redacción final** del **Punto 02** del archivo `AnalisisBrechaCEL.tex`.
...
|---|---|---|---|
| Participantes Obligados (estimaciones vía Declaracel) | DACG S-CEL (RES/174/2016 y A/067/2017) | Disposiciones 49 y 50 | “Declaracel es la herramienta dentro del S-CEL que permite a los Participantes Obligados realizar sus Liquidaciones provisionales… informará sobre: … su estimación de consumo del mes…”. |
| CENACE (medición y liquidación) | DACG S-CEL (RES/174/2016 y A/067/2017) | Disposición 32.B | “Los datos de medición… reportados por el Cenace al S-CEL serán la base para el otorgamiento de los CEL…”. |
| Transportistas y Distribuidores (energía mensual) | DACG S-CEL | Disposición 26 | “En los diez primeros días hábiles… informarán… la energía eléctrica generada…”. |
| SENER (metas y requisitos) | Ley del Sector Eléctrico (LSE 2025) | Artículos 147 y 148 | “La Secretaría establecerá los requisitos para la adquisición de CEL…”. |


Clasifica cada fuente como: **primaria**, **declarativa**, **validación**, **auditoría/supervisión** o **planeación**.


## ENFOQUE ESPECÍFICO DEL PUNTO 2 (OBLIGATORIO)
- Tratar Declaracel como **fuente declarativa** (no primaria) y describir sus límites probatorios.
- Identificar riesgos: **sub/sobre-estimación**, inconsistencias con medición, y efectos sobre obligaciones.
- Proponer controles: validaciones, conciliación contra fuentes primarias, alertas y cierres.
- Incluir tabla “Antes vs Mejora” enfocada en **certidumbre** y **prevención de incumplimiento involuntario**.
