# 🧠 PLANTILLA MAESTRA DEL AGENTE – PUNTO 03
## Bolsa No Onerosa: Reglas, Transparencia y Efectos de Mercado
...
## OBJETIVO DEL AGENTE
Realiza la **validación jurídica integral** y la **redacción final** del **Punto 03** del archivo `AnalisisBrechaCEL.tex`.
...
|---|---|---|---|
| Bolsa No Onerosa | DACG S-CEL (RES/174/2016 y A/067/2017) | Disposición correspondiente | “Los CEL asignados sin contraprestación…” (citar literal exacto desde `contexto`). |
...
| CENACE (oferta real) | Bases del Mercado Eléctrico | Base aplicable | “El CENACE notificará la energía generada…” (citar literal exacto desde `contexto`). |


Clasifica cada fuente como: **primaria**, **declarativa**, **validación**, **auditoría/supervisión** o **planeación**.


## ENFOQUE ESPECÍFICO DEL PUNTO 3 (OBLIGATORIO)
- Describir finalidad y supuestos de procedencia de la Bolsa No Onerosa.
- Identificar distorsiones: señal de precio, incentivos, equidad entre participantes.
- Proponer reglas: criterios objetivos, transparencia agregada, límites y trazabilidad de asignación.
- Incluir ejemplo: flujo de asignación (entrada → criterio → asignación → registro).
