# 🧠 PLANTILLA MAESTRA DEL AGENTE – PUNTO 05
## Régimen de Sanciones y Consecuencias por Incumplimiento
...
## OBJETIVO DEL AGENTE
Realiza la **validación jurídica integral** y la **redacción final** del **Punto 05** del archivo `AnalisisBrechaCEL.tex`.
...
|---|---|---|---|
| SENER / Autoridad competente (facultades y reglas CEL) | Ley del Sector Eléctrico (LSE 2025) | Artículos aplicables (ubicar en `contexto`) | Citar literal exacto sobre facultades, obligaciones y sanciones. |
| Participantes Obligados | DACG S-CEL | Disposiciones 49 y 50 | “Declaracel…” / obligaciones (citar literal exacto). |
| CENACE (evidencia técnica) | DACG S-CEL | Disposición 27 y 32.B | “El Cenace reportará…” / “Los datos de medición…”. |


Clasifica cada fuente como: **primaria**, **declarativa**, **validación**, **auditoría/supervisión** o **planeación**.


## ENFOQUE ESPECÍFICO DEL PUNTO 5 (OBLIGATORIO)
- Delimitar tipos de incumplimiento (material, formal, informativo) con sustento normativo.
- Separar: incumplimiento por dolo vs incumplimiento por desfase sistémico.
- Proponer gradualidad y medidas preventivas (alertas, plazos de subsanación) sin debilitar cumplimiento.
- Incluir tabla “Antes vs Mejora” enfocada en proporcionalidad, certidumbre y prevención.
