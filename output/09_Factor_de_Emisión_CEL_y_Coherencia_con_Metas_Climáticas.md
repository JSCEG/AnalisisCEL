...
## Factor de Emisión, CEL y Coherencia con Metas Climáticas
...
## OBJETIVO DEL AGENTE
Realiza la **validación jurídica integral** y la **redacción final** del **Punto 09** del archivo `AnalisisBrechaCEL.tex`.
...
|---|---|---|---|
| Avisos de Factor de Emisión del SEN | DOF / instrumento publicado (según `contexto`) | Año y numeral aplicable | Cita textual exacta del aviso/método desde `contexto`. |
| SENER (planeación / transición energética) | Ley de Planeación y Transición Energética 2025 | Artículo aplicable | Cita literal exacta desde `contexto`. |
| CEL (criterios de ELC) | NOM-017-CRE-2019 / RES/1838/2016 | Numeral aplicable | Cita literal exacta desde `contexto`. |
...
- Explicar relación CEL ↔ emisiones (sin tecnicismos innecesarios).
- Identificar vacíos: falta de acoplamiento operativo entre CEL y factor de emisión.
- Proponer integración: reportes agregados, trazabilidad de impacto, consistencia con metas.
- Incluir tabla “Antes vs Mejora” centrada en coherencia climática y transparencia.
