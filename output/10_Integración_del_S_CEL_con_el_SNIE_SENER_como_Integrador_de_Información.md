# 🧠 PLANTILLA MAESTRA DEL AGENTE – PUNTO 10
## Integración del S-CEL con el SNIE (SENER como Integrador de Información)
...
## OBJETIVO DEL AGENTE
Realiza la **validación jurídica integral** y la **redacción final** del **Punto 10** del archivo `AnalisisBrechaCEL.tex`.
...
|---|---|---|---|
| SENER (facultades de integración / planeación) | Ley de Planeación y Transición Energética 2025 | Artículo aplicable | Cita literal desde `contexto`. |
| S-CEL (datos y obligaciones) | DACG S-CEL | Disposiciones aplicables | Cita literal desde `contexto`. |
| CENACE (datos del SEN) | Bases del Mercado / Manuales | Numeral aplicable | Cita literal desde `contexto`. |


Clasifica cada fuente como: **primaria**, **declarativa**, **validación**, **auditoría/supervisión** o **planeación**.


## ENFOQUE ESPECÍFICO DEL PUNTO 10 (OBLIGATORIO)
- Definir qué datos del S-CEL deben integrarse al SNIE y para qué fin (planeación, seguimiento, transparencia).
- Identificar riesgos de duplicidad y falta de interoperabilidad.
- Proponer reglas de interoperabilidad: diccionarios, periodicidad, roles, responsabilidades.
- Incluir tabla “Antes vs Mejora” enfocada en gobernanza de datos.
