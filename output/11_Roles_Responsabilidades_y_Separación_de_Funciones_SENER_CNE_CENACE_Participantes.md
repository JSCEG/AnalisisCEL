# 🧠 PLANTILLA MAESTRA DEL AGENTE – PUNTO 11
## Roles, Responsabilidades y Separación de Funciones (SENER, CNE, CENACE, Participantes)
...
## OBJETIVO DEL AGENTE
Realiza la **validación jurídica integral** y la **redacción final** del **Punto 11** del archivo `AnalisisBrechaCEL.tex`.
...
|---|---|---|---|
| SENER (metas y disposiciones) | LSE 2025 | Artículos 147 y 148 | Cita literal desde `contexto`. |
| Autoridad reguladora (CNE) | Instrumento aplicable en `contexto` | Artículo/numeral aplicable | Cita literal exacta desde `contexto`. |
| CENACE (operación y reportes) | Bases del Mercado / DACG S-CEL | Numeral aplicable | Cita literal exacta. |


Clasifica cada fuente como: **primaria**, **declarativa**, **validación**, **auditoría/supervisión** o **planeación**.


## ENFOQUE ESPECÍFICO DEL PUNTO 11 (OBLIGATORIO)
- Definir roles y responsabilidades por función: medir, validar, otorgar, registrar, supervisar, sancionar, planear.
- Señalar riesgos por concentración de funciones o ambigüedad.
- Proponer una matriz RACI (Responsable/Aprobador/Consultado/Informado) en tabla.
- Incluir tabla “Antes vs Mejora” enfocada en claridad institucional y trazabilidad de decisiones.
